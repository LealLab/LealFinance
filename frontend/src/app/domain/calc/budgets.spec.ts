...
describe('budgetProgress', () => {
  const categories: Category[] = [
    { id: 'groceries', name: 'Supermercado', kind: 'expense', groupId: 'food', color: '#000', icon: 'tag', position: 0 }
  ];
  const budget: Budget = { id: 'b1', groupId: 'food', month: '2026-01', amount: '200', currency: 'BRL' };

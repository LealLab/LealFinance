...
SYSTEM_PROMPT = (
    ...
    "one call per category. Deleting a category or group fails while it is still in use (a "
    "transaction, recurring rule, or - for a group - a remaining category); tell the user that "
    "instead of retrying.\n\n"
